...
Requirements describe desired behaviour and ordered change packages. They do not mirror the code folder structure.
...
User Story observable behaviour or scenario
